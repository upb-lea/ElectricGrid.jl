...
used_methode = ['control.py', 'scipy_solve_ivp', 'scipy_solve_ivp', 'scipy_solve_ivp']#, 'scipy_solve_ivp']#, 'env_standalone', 'scipy_solve_ivp']
used_methode_args = ['','LSODA' , 'RK45', 'RK23']#, 'RK23']#, '', 'RK23']
