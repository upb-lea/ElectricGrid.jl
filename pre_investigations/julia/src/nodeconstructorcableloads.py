...
class NodeConstructorCableLoads():
    ...
    def __init__(self, num_source, num_load, CM=None, parameter=None, S2S_p=0.1, S2L_p=0.8):
        ...
        if isinstance(parameter, dict):
            ...
            self.num_RLC_load, self.num_RL_load, self.num_RC_load, self.num_R_load = self.cntr_loadtypes(
                self.parameter['load'])
    ...
    def get_load_distribution(self):
        ...
        # TODO
        self.num_R_load = self.num_load# int(np.floor(sample[0]))
        self.num_RL_load = 0#int(np.floor(sample[1]))
        self.num_RC_load = 0#int(np.floor(sample[2]))
        self.num_RLC_load = 0#self.num_load - (self.num_R_load + self.num_RL_load + self.num_RC_load)
        pass
