...
The interactive content related to the section described here can be found in the form of a notebook [here](https://github.com/upb-lea/JuliaElectricGrid.jl/blob/main/examples/notebooks/RL_Single_Agent_DEMO.ipynb).
...
For more information on how to setup an environment see [Configuring the Environment](https://upb-lea.github.io/JuliaElectricGrid.jl/dev/Env_Create/).
...
The reference value has to be normalized in an appropriate way that it fits to the range of the normalized states (for more information about normalization see [Interaction with the ElectricGridEnv](https://upb-lea.github.io/JuliaElectricGrid.jl/dev/Env_Interaction/)).
